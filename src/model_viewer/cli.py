...
def build_parser() -> argparse.ArgumentParser:
    ...
    show.add_argument("--view", default="overview", help="all or comma list: overview,heatmap,detail,mapping,memory,tree,patterns,blocks")
    ...
    diff.add_argument("--view", default="all", help="all or comma list: overview,heatmap,detail,mapping,memory,tree,patterns,blocks")
